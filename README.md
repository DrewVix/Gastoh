...
- [Docker Desktop](https://www.docker.com/products/docker-desktop) (Windows/Mac) o Docker + Docker Compose (Linux/Raspberry Pi)
...
```powershell
git clone https://github.com/DrewVix/Gastoh.git
cd Gastoh
.\setup.ps1
```
